...
public class MainActivity extends AppCompatActivity {
    ...
    // Replaces the currently displayed message with a new one
    ...
    // Handles multi-threading errors
    ...
    // Bluetooth Client class to communicate with a Server class (TM4)
    ...
    // Sends and receives data through the Client class bluetooth socket
